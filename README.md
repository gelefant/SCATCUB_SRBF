...
1. demo_adaptive  - demo for the numerical experiments on the adaptive algorithm for integration. It might include two input parameters f_type, domain_type
                     domain_type : to choose the spherical polygon and it takes values 1,2,3 - 1: Africa region; 2: Australian region; 3: America region, 4: spherical annulus
                     f_type      : to choose the integrand function it goes from 1 to 33
                                   the test functions of the paper are:     1. Africa region     : f1: 28, f2: 27, f3: 29, f4: 34
                                                                            2. Australia region  : f1: 30, f2: 27, f3: 31, f4: 35
                                                                            3. America region    : f1: 32, f2: 27, f3: 33, f4: -
                                                                            4. Spherical annulus : f1: 37, f2: 27, f3: 38, f4: 36 
```
```
